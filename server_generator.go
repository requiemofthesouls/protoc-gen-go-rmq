...
import (
	...
	optionspb "github.com/requiemofthesouls/protoc-gen-go-rmq/pb"
)
...
func generateServers(gen *protogen.Plugin, file *protogen.File) {
	...
	g.P("\"context\"")
	g.P()
	g.P("\"github.com/requiemofthesouls/svc-rmq/server\"")
	g.P("\"github.com/requiemofthesouls/svc-rmq/server/consumer\"")
